      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
            ...
            pw.SizedBox(height: 20),
            _buildInfoSection('Detailed Analysis', med.simpleExplanation),
            _buildInfoSection('Indications', med.usedFor.join(', ')),
            _buildInfoSection('Usage Instructions', med.whenToUse.join('\n• ')),
            if (med.dosage != null) _buildInfoSection('Dosage Guidance', med.dosage!),
            _buildInfoSection('Side Effects', med.sideEffects.join(', ')),
            pw.SizedBox(height: 20),
            _buildWarningSection(med.contraindications.join('\n• ')),
            pw.Spacer(),
            _buildFooter(),
          ];
        },
